...
- **Периферійні пристрої** — виявляйте MIPI- та USB-камери, формуйте конфігурації входу камери та запускайте, перевіряйте, підтримуйте сигналами heartbeat або зупиняйте тимчасовий попередній перегляд камери на вибраній платі.
