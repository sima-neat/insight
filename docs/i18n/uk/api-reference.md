...
- **Плата** — виберіть плату, яку використовують функції для роботи з платою, перевірте з’єднання SSH і довіртеся ключу хоста перепрошитої плати.
- **Периферійні пристрої** — виявляйте MIPI- та USB-камери на вибраній платі й формуйте конфігурації входу камери через API.
- **Sentinel** — перевіряйте та встановлюйте демон Sentinel на вибраній платі, зчитуйте його показники в реальному часі й нещодавню історію, а також починайте, зупиняйте, переглядайте, порівнюйте та видаляйте трасування.
