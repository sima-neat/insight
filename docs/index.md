...
Insight is bundled with the Neat Development Environment and is also available as a Neat artifact package that you can install or upgrade with `sima-cli neat install`.
...
In the Neat Development Environment, open Insight from a browser:
...
6. Use Workspace to inspect artifacts, and use the Stats placeholder to understand where system/runtime diagnostics will land in the next release.