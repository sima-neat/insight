...
- **Peripherals** — discover MIPI and USB cameras, render camera input configurations, and start, inspect, heartbeat, or stop a temporary camera preview on the selected board.
